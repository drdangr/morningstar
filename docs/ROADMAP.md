...
- [ ] **🚨 КРИТИЧЕСКАЯ ПРОБЛЕМА: Сбор новостей при периоде >1 дня** — требует решения сегодня
  - [ ] **Диагностика N8N workflow:** проверить ноды "Prepare for AI" и "OpenAI API"
  - [ ] **Анализ временных диапазонов:** убедиться в корректной фильтрации по датам
  - [ ] **Проверка таймаутов API:** возможные лимиты обработки больших объемов
  - [ ] **Тестирование с разными периодами:** 2 дня, 3 дня, неделя
