...
### Этап 4. Backend API для дайджестов и интеграция систем
**Цель:** создать Backend API для сохранения дайджестов из N8N и подготовить систему к интеграции с публичным Telegram-ботом.
...
- [ ] Тестирование полной цепочки: Userbot → N8N → AI → Backend API → БД
...
- Полная End-to-End цепочка протестирована и документирована
