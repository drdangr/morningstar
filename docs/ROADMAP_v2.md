...
по мере выполнения видоизменяй задачи следующим образом: 
...
### День 11. 12 июня 2025 🎯 **STAGE 1.5: Tasks 0-1 ЗАВЕРШЕНЫ + Task 2-4**

**🎯 ЦЕЛЬ ДНЯ:** Завершить STAGE 1.5 - подготовить админ-панель к мультитенантной архитектуре
...
- [ ] **Task 2: Реорганизация настроек**: Перенести настройки дайджестов из LLM Settings в Public Bots Management
    - [ ] Проанализировать текущие настройки в LLM Settings
    - [ ] Определить какие настройки относятся к дайджестам
    - [ ] Подготовить структуру для Public Bots Management
    - Definition of Done: LLM Settings содержат только AI параметры, настройки дайджестов перенесены
- [ ] **Task 3: Public Bots Management**: Создать новую закладку для управления публичными ботами
    - [ ] Создать PublicBotsPage.jsx с базовой структурой
    - [ ] Добавить панель выбора публичного бота
    - [ ] Реализовать настройку каналов и категорий для ботов
    - [ ] Добавить настройки AI промптов для каждого бота
    - Definition of Done: Страница Public Bots работает, можно управлять ботами
- [ ] **Task 4: Userbot Management**: Создать закладку для управления userbot
    - [ ] Создать UserbotPage.jsx с интерфейсом управления
    - [ ] Добавить кнопки принудительного обновления каналов
    - [ ] Перенести настройки userbot из других разделов
    - Definition of Done: Centralised управление userbot через админ-панель
