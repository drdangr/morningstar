-- Migration 011: Create processed_data table for AI Services (Simplified)
...
-- Create processed_data table (без внешних ключей из-за партиционирования)
...
COMMENT ON COLUMN processed_data.post_id IS 'Reference to posts_cache.id (no FK due to partitioning)';
COMMENT ON COLUMN processed_data.public_bot_id IS 'Reference to public_bots.id';
